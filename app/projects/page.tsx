...
const projects = [
  ...
  },
  {
    ...
    description: 'An immersive 3D space exploration experience built with React Three Fiber. Features interactive solar system visualization, realistic planetary animations, and dynamic camera controls. Showcases modern 3D web technologies with smooth performance and stunning visual effects.',
    image: 'https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=800&h=600&fit=crop',
    tags: ['Next.js', 'React Three Fiber', 'Tailwind', 'TypeScript'],
    liveUrl: 'https://cosmicgenesis.netlify.app/',
    githubUrl: 'https://github.com/OlenaBoichenko/cosmic-genesis',
    inDevelopment: false,
  },
  {
    id: 3,
